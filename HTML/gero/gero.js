...
{
	doccument.getElementById("id_alpha").innerHTML = Math.round( e.alpha * 100)/ 100;
	doccument.getElementById("id_beta").innerHTML = Math.round( e.beta * 100)/ 100;
	doccument.getElementById("id_gamma").innerHTML = Math.round( e.gamma * 100)/ 100;
}
